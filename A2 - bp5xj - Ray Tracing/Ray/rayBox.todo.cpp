...
double RayBox::intersect(Ray3D ray,RayIntersectionInfo& iInfo,double mx){
    ...
    Plane3D bottom = *(new Plane3D( b1, b2, b3 ));
    planes[0] = bottom;
    ...
    Plane3D top = *(new Plane3D( t1, t2, t3 ));
    planes[1] = top;
    ...
    Plane3D left = *(new Plane3D( l1, l2, l3 ));
    planes[2] = left;
    ...
    Plane3D right = *(new Plane3D( r1, r2, r3 ));
    planes[3] = right;
    ...
    Plane3D back = *(new Plane3D( ba1, ba2, ba3 ));
    planes[4] = back;
    ...
    Plane3D front = *(new Plane3D( f1, f2, f3 ));
    planes[5] = front;
